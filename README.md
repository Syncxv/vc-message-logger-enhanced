...
- [ ] Intercept image requests and return image blob (async issues)
    - Possible Solutions:
        - Image Server. (wont work if we dont have access to node js)
        - Patch Image class
            - Patch Image Problems
                - [ ] need to figure out how to make async image loading work
